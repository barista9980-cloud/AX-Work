...
def generate_2025_gsheets():
    ...
    filename_base = "2025년12월31일기준_부동산자산현황_보고서"
    ...
    if os.path.exists(GDRIVE_OUTPUT_DIR):
        wb.save(xlsx_gdrive)
        print(f"Saved XLSX to GDrive: {xlsx_gdrive}")
