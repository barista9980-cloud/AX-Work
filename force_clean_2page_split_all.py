...
print(f"Applying MANDATORY CLEAN 2-PAGE SPLIT before Section 3 to eliminate all awkward mid-table splits across {FOXCONNECT_ROOT}...")
...
for root, dirs, files in os.walk(FOXCONNECT_ROOT):
    ...
    # MANDATORY CLEAN PAGE BREAK BEFORE SECTION 3 FOR EVERY DOCUMENT!
    # PAGE 1: Section 1 (Table 0) & Section 2 (Table 1)
    # PAGE 2: Section 3 (Table 2) & Section 4 (Table 3)
    doc.add_page_break()

    # Section 3 Heading: "3. 임대인 및 납부 계좌 정보" (At Top of Page 2)
    ...
    try:
        ...
        print(f"  [MANDATORY CLEAN 2-PAGE SPLIT APPLIED] {new_docx_filename}")
        generated_notes += 1
    except Exception as e:
...
print(f"\n==========================================")
print(f"Finished applying mandatory 2-page split across all 29 property notes! Total folders: {processed_folders}")
