...
for s_dir in sub_dirs:
    ...
    for u_dir in unit_dirs:
        ...
        # Section 1 Heading: 소제목 11pt Bold ("1. 주 계약 정보")
        ...
        # Table 0: 주 계약 정보 (5 rows, 4 cols, Cell font 10pt)
        ...
        # Section 2 Heading: 소제목 11pt Bold ("2. 수록 계약서 문서 목록 (총 N건)")
        ...
        # Section 3 Heading: 소제목 11pt Bold ("3. 임대인 및 납부 계좌 정보") - NO EMPTY ENTER PARAGRAPHS BEFORE IT!
        ...
        # Section 4 Heading: 소제목 11pt Bold ("4. 계약 변동 이력 및 특이사항")
        ...
        try:
            ...
            print(f"    [CREATED PERFECT NOTE WITH BLACK BORDERS] {new_docx_filename}")
            processed_count += 1
        except Exception as e:
            print(f"    [ERROR SAVING] {new_docx_filename}: {e}")

print(f"\n==========================================")
print(f"Finished processing 01_가산 to 04_광명! Total notes regenerated with black borders: {processed_count}")
print(f"==========================================")
