...
pdf_files = sorted([f for f in os.listdir(dogok_path) if f.endswith(".pdf")])
...
b_name = "02_강남_도곡로1길23"
u_name = "지하1층,1층,2층,3층"
...
format_data_cell(t2.rows[0].cells[3], f"{primary_item['party_b']}(폭스커넥트 법인)", bold=False, font_size=10.0, align=WD_ALIGN_PARAGRAPH.CENTER, bg_hex="FFFFFF")
...
remarks_text = f"1. 본 건은 {u_name} 건물 전층 최초임대차계약 건임.\n2. 최초 작성 시 원본 PDF 확인 후 관리자 검토를 진행해 주세요."
...
output_docx_path = os.path.join(dogok_path, "부동산_계약관리노트_지하1층,1층,2층,3층.docx")
doc.save(output_docx_path)
print("Successfully updated Dogok Note with all 8 files!")
