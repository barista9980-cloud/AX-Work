...
def parse_pdf_page_with_vision(pdf_path):
    try:
        ...
        print(f"  [VISION AI ERROR] {os.path.basename(pdf_path)}: {e}")
        return None

processed_folders = 0
updated_notes = 0

print("Starting Vision LLM Gemini 3.5 Flash Batch Processing across G:\\내 드라이브\\[FoxConnect]...")
...
for root, dirs, files in os.walk(FOXCONNECT_ROOT):
    ...
    # Format master info for docx template
    ...
    # Docs list formatting for Table 1
    docs_list = []
