...
def format_header_cell(cell, text, font_size=10.0, align=WD_ALIGN_PARAGRAPH.CENTER, bg_hex="F1F5F9"):
    ...
    for r in p.runs:
        ...
        r.bold = True
        r.font.color.rgb = RGBColor(30, 41, 59) # Slate Dark
...
print(f"Applying Complete Executive Visual Design Pass to {FOXCONNECT_ROOT}...")
...
for root, dirs, files in os.walk(FOXCONNECT_ROOT):
    ...
    # P0 Title: 13pt Bold 맑은 고딕 (Slate Dark)
    ...
    # Section 1 Heading: "1. 계약 정보" (11pt Bold Slate Accent)
    ...
    # Table 0: 계약 정보 (5 rows, 4 cols, 10pt, clean border #334155)
    ...
    # Table 1: BEAUTIFUL EXEC DASHBOARD TABLE
    ...
    for idx, c_it in enumerate(contract_items, 1):
        ...
        # Col 1: 문서명 (CLEAN DUAL-LINE DESIGN)
        cell1 = r_cells[1]
    ...
    sec3_p.paragraph_format.space_before = Pt(10)
    ...
    # Table 2: 임대인 및 계좌 정보 (4 rows, 4 cols, 10pt, clean border #334155)
    ...
    sec4_p.paragraph_format.space_before = Pt(10)
    ...
    # Table 3: 계약 변동 이력 (4 rows, 2 cols, 10pt, clean border #334155)
    ...
    # Save completely polished document
    ...
    try:
        ...
        print(f"  [FULL EXECUTIVE DESIGN PASS COMPLETE] {new_docx_filename}")
        generated_notes += 1
    except Exception as e:
...
print(f"\n==========================================")
print(f"Finished applying complete executive design system! Total folders: {processed_folders}")
